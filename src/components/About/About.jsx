...
const About = () => {
  ...
  return (
    <section className={`container__about p-4 ${theme}__about`} id="About">
      ...
      <div className="d-flex flex-wrap">
        ...
        <div className="text-container__about">
          ...
          <p className={`social-media__about ${theme}-social-media__about`}>
            <a
              href="https://github.com/nicolasggdev"
              target="_blank"
            ...
            <a
              href="http://www.linkedin.com/in/nicolasggdev"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
